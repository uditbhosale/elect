                ...
                <div class="col-md-8 cart">
                    <div class="title">
                        ...
                        <div class="row main align-items-center">
                            <div class="col-2"><img alt="" src="data:image/*;base64, <%= base64Image %>"></div>
                            <div class="col">
                                <div class="row text-muted"><%=p.getProduct_namel() %></div>
                                <div class="row"><%=p.getDescription()%></div>
                            </div>
                            <div class="col">
